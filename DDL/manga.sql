CREATE TABLE `manga` (
  ...
  `start_month` VARCHAR(7) DEFAULT NULL COMMENT '連載開始年月',
  `end_month` VARCHAR(7) DEFAULT NULL COMMENT '連載終了年月',
  ...
  `target_sex` TINYINT NOT NULL DEFAULT 0 COMMENT '対象性別',
  `release_status` TINYINT NOT NULL DEFAULT 0 COMMENT '連載状況',
